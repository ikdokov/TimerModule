...
public class Main2Activity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, ProjectsListFragment.OnListFragmentInteractionListener, CreateProjectFragment.OnNewProjectFragmentInteractionListener {
    ...
    public void onNewProjectCreated(Project project) {
        Toast.makeText(Main2Activity.this, "Project " + project.getTitle() + " successfully created.", Toast.LENGTH_SHORT).show();
    }
}
